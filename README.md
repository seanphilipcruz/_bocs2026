...
Laravel 13 migration of the BOCS API. Existing URLs, controllers, models,
database migrations, Passport authentication, contract PDF/text generation,
reporting, notifications, and shared controller traits are preserved.
...
4. Create the Passport personal access client with
...
`vendor/bin/pint --test` before deployment.
